...
public abstract class BaseController {
    ...
    protected <T> ResponseEntity<ApiResponse<T>> ok(String message, T data) {
        return getResponseEntity(HttpStatus.OK, message, data);
    }

    protected <T> ResponseEntity<ApiResponse<T>> create(String message, T data) {
        return getResponseEntity(HttpStatus.CREATED, message, data);
    }
    ...
    protected <T> ResponseEntity<ApiResponse<T>> unauthorized(String message) {
        return getResponseEntity(HttpStatus.UNAUTHORIZED, message, null);
    }
    ...
    private <T> ResponseEntity<ApiResponse<T>> getResponseEntity(
        ...
        return ResponseEntity.status(httpStatus)
            .body(ApiResponse.of(httpStatus, message, data));
    }
}
